...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#030712] text-white selection:bg-violet-600/30 overflow-x-hidden">
      {/* Glow effects */}
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-violet-700/10 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute top-[20%] right-1/4 w-[400px] h-[400px] bg-blue-700/10 rounded-full blur-[120px] pointer-events-none"></div>

      {/* Navigation */}
      <header className="sticky top-0 z-50 glass border-b border-white/5 bg-slate-950/80 backdrop-blur-md px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
          <div className="h-9 w-9 rounded-lg bg-gradient-to-tr from-violet-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-violet-500/25">
          ...
          <span className="font-outfit font-bold text-xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">
            ResumeForge <span className="text-violet-500 text-sm font-semibold uppercase">AI</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          {isAuthenticated ? (
            ...
            <>
              ...
              <button onClick={handleDemoAccess} disabled={loading} className="hidden sm:flex px-4 py-2 rounded-lg border border-violet-500/30 hover:border-violet-500/80 text-violet-400 font-medium transition-all text-sm bg-violet-950/20">
      ...
      <section className="relative pt-20 pb-24 px-6 text-center flex flex-col items-center">
        <motion.div
          ...
          className="flex items-center gap-2 px-3 py-1 rounded-full border border-violet-500/20 bg-violet-950/20 text-violet-400 text-xs font-semibold uppercase tracking-wider mb-8"
        >
        ...
        >
          <button onClick={() => navigate('/register')} className="px-8 py-3.5 rounded-lg bg-gradient-to-r from-violet-600 to-indigo-600 font-semibold text-white shadow-lg shadow-violet-500/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2">
        ...
        >
          ...
          <div className="flex items-center justify-between pb-3 border-b border-white/5 text-xs text-slate-500 mb-4 px-2">
            ...
            <div className="flex items-center gap-3">
              <span className="bg-green-500/10 text-green-400 font-semibold px-2 py-0.5 rounded flex items-center gap-1"><ShieldCheck className="w-3 h-3" /> Live ATS: 92/100</span>
              <span className="text-violet-400 flex items-center gap-1 font-semibold"><Sparkles className="w-3 h-3 animate-spin" /> Suggesting keywords...</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 h-[350px] overflow-hidden">
            ...
            <div className="col-span-1 border-r border-white/5 pr-4 flex flex-col gap-3 text-left">
              ...
              <div className="h-24 w-full bg-violet-950/20 border border-violet-500/20 rounded p-2 text-[10px] text-violet-300">
            ...
            <div className="col-span-2 bg-white text-slate-800 p-8 rounded-lg shadow-inner text-left font-sans flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                <h4 className="text-[10px] font-bold text-violet-600 tracking-wider uppercase">PROFESSIONAL EXPERIENCE</h4>
                ...
                <p className="text-[10px] text-slate-600 leading-relaxed font-light mt-1 pl-2 border-l border-violet-500">
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
          <div className="p-6 rounded-xl border border-white/5 bg-slate-900/30 hover:border-violet-500/20 transition-all flex flex-col gap-4">
            <div className="h-10 w-10 rounded-lg bg-violet-600/10 flex items-center justify-center text-violet-400 border border-violet-500/20">
          ...
          <div className="p-6 rounded-xl border border-white/5 bg-slate-900/30 hover:border-violet-500/20 transition-all flex flex-col gap-4">
            <div className="h-10 w-10 rounded-lg bg-blue-600/10 flex items-center justify-center text-blue-400 border border-blue-500/20">
          ...
          <div className="p-6 rounded-xl border border-white/5 bg-slate-900/30 hover:border-violet-500/20 transition-all flex flex-col gap-4">
            <div className="h-10 w-10 rounded-lg bg-indigo-600/10 flex items-center justify-center text-indigo-400 border border-indigo-500/20">
          ...
          <div className="p-6 rounded-xl border border-white/5 bg-slate-900/30 hover:border-violet-500/20 transition-all flex flex-col gap-4">
            <div className="h-10 w-10 rounded-lg bg-purple-600/10 flex items-center justify-center text-purple-400 border border-purple-500/20">
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 flex flex-col gap-6 text-left">
            ...
            <div className="flex flex-col gap-3 font-semibold text-slate-300">
              <div className="flex items-center gap-2"><Zap className="text-violet-500 w-4 h-4" /> Google, Microsoft, and Stripe Styles</div>
              <div className="flex items-center gap-2"><Zap className="text-violet-500 w-4 h-4" /> Executive Serif and Elegant Layouts</div>
              <div className="flex items-center gap-2"><Zap className="text-violet-500 w-4 h-4" /> Developer Monospace and Minimal Formats</div>
            </div>
          </div>
      ...
      <section id="pricing" className="py-24 px-6 max-w-6xl mx-auto border-t border-white/5 text-center">
        ...
        <div className="flex justify-center items-center gap-4 mt-8">
          ...
          <button onClick={() => setBillingCycle(billingCycle === 'monthly' ? 'yearly' : 'monthly')} className="w-12 h-6 rounded-full bg-violet-600 p-1 flex items-center transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
          ...
          {/* Tier 2 (Pro) */}
          <div className="p-8 rounded-2xl border-2 border-violet-500 bg-slate-900/60 flex flex-col justify-between relative shadow-lg shadow-violet-500/10">
            <span className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-violet-600 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full">Most Popular</span>
            <div>
            ...
            <button onClick={() => navigate('/register')} className="mt-8 w-full py-2.5 rounded-lg bg-violet-600 hover:bg-violet-700 transition-all text-sm font-semibold text-white shadow shadow-violet-500/20">
              Go Pro Now
            </button>
          </div>
